    ...
    <div class="site-wrap" style="min-height: 70vh;font-family: 'Quicksand', sans-serif;overflow-x: hidden !important; background:white;">
        ...
        <div class="site-section" data-aos="fade-top" style="padding: 2.5em 0;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="title" style="color: #ee4266;">ORDER # <?php echo $orderDetails['order_no']; ?> : CANCELLED</h1>
                        <h2 class="sub-title">Hello <?php echo $orderedBy["email"]; ?>, your order has been cancelled and a refund will be processed via the original method of payment within 14 days.</h2>
                        <img src="https://bespokeboxx.co.uk/images/cross.png" class="tick-img" style="width: 150px;display: block;margin-left: auto;margin-right: auto;">
                    </div>
                    <div class="col-md-12">
